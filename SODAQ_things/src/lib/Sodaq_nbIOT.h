...
class Sodaq_nbIOT: public Sodaq_AT_Device
{
    ...
    private:
        ...
        static ResponseTypes _csgnParser(ResponseTypes& response, const char* buffer, size_t size, char* stringBuffer, size_t* stringBufferSize);
